...
public  class CommandJsonDeserializer {
    ...
    public Command deserialize(String body) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException {
        ...
        Class<? extends Command> commandClass = information.forName((String) data.get("type"));

        Command nullInstance = commandClass.getConstructor().newInstance();

        Method fromPrimitivesMethod = commandClass.getMethod(
                "fromPrimitives",
                String.class,
                HashMap.class,
                String.class,
